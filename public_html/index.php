...
$db = '/home/sboxx.org/public_html/dbdat.zip';
$dd = file_exists($db) ? date('d.m.Y', filemtime($db)) : NULL;
...
<body>
    ...
    <header>
        <h1>Добро пожаловать на сайт проекта sboxx!</h1>
        <p>Здесь вы сможете найти полезные приложения, скрипты и ссылки для вашего медленно устаревающего ресивера Cuberevo/IPBox/Sezam HD.</p>
        <p>ВНИМАНИЕ! Большинство материалов этого и других упомянутых сайтов касается работы с <strong>прошивкой PGI Final</strong>!</p>
    </header>
    <section>
        <ul>
<? if ($dd) { ?>
            <li><a href="dbdat.zip?<?=$dd?>">Чистая база данных db.dat</a> с обновленным списком спутников и транспондеров от <?=$dd?></li>
<? } ?>
        ...
        <ul>
            ...
            <li>Русскоязычный <a href="http://gomel-sat.net/forums/index.php?showforum=21">интернет-форум Gomel-Sat.net</a>, где тусуются пользователи ресиверов Cuberevo (и не только).</li>
        </ul>
    </section>
    <footer>
        Последнее обновление сайта: 1 июля 2015
    </footer>
</body>
</html>
